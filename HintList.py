...
hintTable = {
    ...
    'Green Rupee (Treasure Chest Game)':                        ("the green gem of grief", 'a Green Rupee', 'item'),
    'Blue Rupee (Treasure Chest Game)':                         ("the blue gem of blunder", 'a Blue Rupee', 'item'),
    'Red Rupee (Treasure Chest Game)':                          ("the red gem of regret", 'a Red Rupee', 'item'),
    'Purple Rupee (Treasure Chest Game)':                       ("the purple gem of punishment", 'a Purple Rupee', 'item'),
