...
item_draw_table_entry_t item_draw_table[] = {
    ...
    [0x7D] = { draw_gi_various_opa0,        { 0x060006A0, 0x060008E0, 0x06001280, 0xBA3F3AFF, 0xA5231EFF, 0x1695D2FF, 0x054C7FFF } }, // Bombchu Bag
    ...
    [0x7F] = { draw_gi_shrink_keys,         { 0x06001110, 0x94E97BFF, 0x2CCF1AFF } }, // Small Key (Forest)
