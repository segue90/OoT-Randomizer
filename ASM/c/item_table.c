...
item_row_t item_table[] = {
    ...
    [0x003D] = ITEM_ROW(0x3D,       HEART_CHEST, 0x72, -1, 0x00C6, 0x00BD, 0x13, health_upgrade_cap, clear_excess_hearts, -1, -1), // Heart Container
    [0x003E] = ITEM_ROW(0x3E,       HEART_CHEST, 0x7A, -1, 0x00C2, 0x00BD, 0x14, health_upgrade_cap, full_heal, -1, -1), // Piece of Heart
    ...
    [0x004F] = ITEM_ROW(0x3D,       HEART_CHEST, 0x72, -1, 0x00C6, 0x00BD, 0x13, no_upgrade, full_heal, -1, -1), // Heart Container
    ...
    [0x0076] = ITEM_ROW(0x53,       HEART_CHEST, 0x7A, -1, 0x00FA, 0x00BD, 0x14, health_upgrade_cap, full_heal, -1, -1), // Piece of Heart (Chest Game)
    ...
    [0x007D] = ITEM_ROW(0x3E,       HEART_CHEST, 0x41, -1, 0x90C2, 0x00BD, 0x14, no_upgrade, full_heal, -1, -1), // Capped Piece of Heart
    [0x007E] = ITEM_ROW(0x3E,       HEART_CHEST, 0x41, -1, 0x90C6, 0x00BD, 0x13, no_upgrade, full_heal, -1, -1), // Capped Heart Container
    [0x007F] = ITEM_ROW(0x53,       HEART_CHEST, 0x41, -1, 0x90FA, 0x00BD, 0x14, no_upgrade, full_heal, -1, -1), // Capped Piece of Heart (Chest Game)
    ...
    [0x00B8] = ITEM_ROW(0x53,       HEART_CHEST, 0x41, -1, 0x00E9, 0x0194, 0x13, no_upgrade, give_defense,      -1, -1), // Double Defense
