...
item_table = {
    ...
    'Green Rupee (Treasure Chest Game)':               ('Item',     None,  0x0072, None),
    'Blue Rupee (Treasure Chest Game)':                ('Item',     None,  0x0073, None),
    'Red Rupee (Treasure Chest Game)':                 ('Item',     None,  0x0074, None),
    'Purple Rupee (Treasure Chest Game)':              ('Item',     None,  0x0075, None),
